# Learnable Multi-Scale Decomposition and Integrated Autocorrelation for Time Series Forecasting
 ...
 We improved the preprint study by adding confidence-aware forecasting option. Cite both of the paper if you use [LMSAutoTSF](models/LMSAutoTSF.py) or [LMSAutoTSFV2.py](models/LMSAutoTSV2F.py).
